	...
	return (
		<div className="w-full min-h-screen h-full max-w-6xl p-8 mx-auto">
			...
			<footer className="w-full flex flex-col items-center justify-center py-4">
				<p className="font-archivo text-xs text-center text-gray dark:text-gray-light">Made with 💚 by <a className="cursor-pointer font-medium underline" href="https://sebastianurdanegui.vercel.app/" target="_blank" rel="noreferrer">Sebastian Marat Urdanegui Bisalaya</a></p>
			</footer>
		</div>
	)
}