...
export async function POST(req: NextRequest) {
  ...
  const result = streamText({
    ...
    system:
      ...
      "Your work is recommended to people a list of fifteen (15) songs that are suitable for the current situation and give a message to the user about your situation. " +
      ...
      "You must verify that the songs list does not contain any duplicate songs. " +
